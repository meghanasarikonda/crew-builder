...
export default class CreateCrew extends Component {
  ...
  handleSubmit(e) {
    ...
    console.log(obj)
    // cloudinary.v2.uploader.upload(this.img.value,
  ...
  render() {
    console.log(this.state.uploadedFileCloudinaryUrl, 'url')
    return (
      <div>
...
// http://res.cloudinary.com/sarikonda/image/upload/c_scale,w_300/megh